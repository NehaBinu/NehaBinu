...
<img src="https://skillicons.dev/icons?i=py,c,cpp,js,ts,html,css,react,nextjs,nodejs,express,mongodb,postgres,mysql,tailwind,framer,firebase,git,github,postman,vscode&perline=11" alt="skills" />
...
|---|---|---|
| [**SkillForge**](https://github.com/NehaBinu/skillforge-ai) | Multi-tenant SaaS for AI-personalized learning paths. Stripe billing with signature-verified webhooks, subscriptions scoped to organizations, role-based dashboards | Next.js, TypeScript, Node, Express, MongoDB, Stripe, Groq |
| [**Lumora**](https://github.com/NehaBinu/lumora-headless-cms) | Headless CMS with JWT auth, role-based access and per-user content isolation. Generates articles and SEO metadata with Groq (Llama 3.1) | Next.js 14, TypeScript, Node, Express, MongoDB |
| [**Inkwell**](https://github.com/NehaBinu/inkwell-blog-app) | Full-stack blog app with JWT authentication | React, Node, PostgreSQL |
| [**Lane Logic**](https://github.com/NehaBinu/lane-logic) | Event-driven traffic demand forecasting prototype for Bengaluru. LightGBM + CatBoost ensemble with geohash features (scored 90.79/100) | Python, LightGBM, CatBoost |
| [**Breast Cancer Prediction**](https://github.com/NehaBinu/MLproject) | PCA + Recursive Feature Elimination + SVM on the WBCD dataset, **99.12% accuracy**, with SHAP to explain the predictions | Python, Scikit-learn, SHAP |
| **BioDegradeX** | IoT compost monitor with real-time sensor data and cloud dashboards | ESP32, Arduino, ThingSpeak |
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/NehaBinu/NehaBinu/output/github-snake-dark.svg" />
    <img alt="contribution snake" src="https://raw.githubusercontent.com/NehaBinu/NehaBinu/output/github-snake.svg" />
  </picture>
</div>
